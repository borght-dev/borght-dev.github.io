...
highlights:
  ...
  - period: "2025"
    title: "Platform-wide documentation system"
    summary: "Built an automated documentation pipeline that traverses the codebase and produces a consistently shaped reference for every component, repository function, and stored procedure — plus a playbook so the system extends itself."
  - period: "2025"
  ...
  - period: "2025"
    title: "Scheduling & planning performance sprint"
    summary: "A focused sprint on the platform's scheduling surface — parallelized sequential awaits, added early returns to hot paths, and rewrote one critical stored procedure to C# behind a feature flag."
  - period: "2025"
    title: "Admin tooling → AvaloniaUI"
    summary: "Converted the legacy admin tooling to AvaloniaUI for cross-platform .NET desktop, with comprehensive test coverage."
  - period: "2025"
    title: "License management portal"
    summary: "Shipped a portal for organisation creation, environment management, and license reporting."
  - period: "2026"
    title: "Daily CodeQL pipeline (Secureframe compliance)"
    summary: "Built and operated the daily CodeQL scan with the right scoping rules for a hybrid .NET / portal monorepo."
  - period: "2026"
    title: "SOAP → internal API migration plan"
    summary: "Designed the staged migration plan as a prerequisite for the next-generation platform."
stack:
